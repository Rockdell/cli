...
namespace tests.Specs
{
    ...
    public class New : IClassFixture<NpmLoginFixture>
    {
        ...
        [Theory]
        [InlineData("9.0.0")]
        [InlineData("10.2.5", true), Trait("TestCategory", "LongRunning"), Trait("TestCategory", "Integration"), Trait("TestCategory", "Node18")]
        [InlineData("10.2.5", true, true), Trait("TestCategory", "LongRunning"), Trait("TestCategory", "Integration"), Trait("TestCategory", "Node18")]
        [InlineData("10.2.7", true, true), Trait("TestCategory", "LongRunning"), Trait("TestCategory", "Integration"), Trait("TestCategory", "Node18")]
        [InlineData("10.2.7"), Trait("TestCategory", "LongRunning"), Trait("TestCategory", "Integration"), Trait("TestCategory", "Node18")]
